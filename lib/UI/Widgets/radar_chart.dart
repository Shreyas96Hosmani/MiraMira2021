...
class RadarChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var tickDistance = radius / 1.2 / (ticks.length);
    var tickLabels = reverseAxis ? ticks.reversed.toList() : ticks;

    if (reverseAxis) {
      TextPainter(
        text: TextSpan(text: "", style: ticksTextStyle),
    ...
    tickLabels
        ...
        .asMap()
        .forEach((index, tick) {
      var tickRadius = tickDistance * (index + 4);
    ...
    features.asMap().forEach((index, feature) {
      var xAngle = cos(angle * index - pi / 4.3);
      var yAngle = sin(angle * index - pi / 4.3);
      ...
      TextPainter(
        text: TextSpan(text: "", style: featuresTextStyle),
